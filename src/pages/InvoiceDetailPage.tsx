...
export default function InvoiceDetailPage() {
  ...
  const handlePdf = async () => {
    setPdfLoading(true);
    await downloadInvoicePdf(inv, 'invoice-print-area');
    setPdfLoading(false);
  };
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex items-center justify-between no-print">
        ...
        <div className="flex gap-2">
          ...
          >
            <Download size={16} />{pdfLoading ? 'Erstelle PDF...' : 'PDF herunterladen'}
          </button>
      ...
      <div id="invoice-print-area" className="card space-y-6">
        ...
        <div className="border-t border-white/10 pt-3 text-center no-print">
          <p className="text-xs text-slate-700">Powered by InvoiceFlow · <a href="https://www.avegandoailabs.com" className="hover:text-violet-400 transition-colors">avegandoailabs.com</a></p>
        </div>
      </div>
